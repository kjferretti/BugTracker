...
namespace BugTracker.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult ChangeName([Bind (Include="NewFirstName,NewLastName")] NewIndexViewModel model)
        {
            if (!ModelState.IsValid)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ChangePassword(NewIndexViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return RedirectToAction("Index");
